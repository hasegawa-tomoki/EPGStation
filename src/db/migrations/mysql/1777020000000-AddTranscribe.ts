...
export class AddTranscribe1777020000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`rule\` ADD \`transcribe\` tinyint NOT NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`reserve\` ADD \`transcribe\` tinyint NOT NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`recorded\` ADD \`transcribe\` tinyint NOT NULL DEFAULT 0`);
    }
