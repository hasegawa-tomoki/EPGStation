...
export const post: Operation = async (req, res) => {
    ...
    try {
        const body = req.body ?? {};
        await model.mkdir(req.params.storageName, body.parentSubPath ?? '', body.folderName ?? '');
...
post.apiDoc = {
    ...
    requestBody: {
        ...
        content: {
            'application/json': {
                schema: { $ref: '#/components/schemas/ExternalStorageMkdirOption' },
            },
        },
    },
    responses: {
